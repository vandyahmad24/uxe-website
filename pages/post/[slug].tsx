...
export default function Post({ post, posts, preview }) {
  ...
  return (
    <Layout>
      ...
      <div className="bg-white p-[max(48px,_min(calc(100vw_*_(170_/_1440)),_170px))_max(20px,_min(calc(100vw_*_(178_/_1440)),_178px))] max-xl:px-[max(20px,_min(calc(100vw_*_(70_/_1440)),_70px))]">
        <div className="max-w-[770px] mx-auto overflow-hidden">
            ...
            <div className="flex items-center gap-[16px]">
              ...
              <div className="flex flex-col gap-[4px]">
                <TextMedium
                  ...
                  cls="font-medium"
                />
                <TextMedium label={post?.date} />
              </div>
            </div>
            <div className="flex gap-[8px]">
              <a
                href="#"
                className="block p-[4px] rounded-[6px] bg-[#BEBEBE40]"
              >
                <svg
          ...
          <img
            src="https://fakeimg.pl/770x400"
            alt="Feature Image"
            className="rounded-[12px] my-[64px]"
          />
          <div>
            {post?.featuredImage && (
              <img
