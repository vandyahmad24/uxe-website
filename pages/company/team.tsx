              ...
              <div key={index} className="flex flex-col items-start gap-[20px] max-[374px]:items-center">
                ...
                <div className="flex flex-col gap-[12px]">
                  ...
                  <div className="flex items-center gap-[12px]">
                    ...
                    {social_media?.twitter && social_media.twitter != '' && (
                      <Link href={social_media.twitter} className="hover:opacity-75">
                        <svg
                    ...
                    {social_media?.linkedin && social_media.linkedin != '' && (
                      <Link href={social_media.linkedin} className="hover:opacity-75">
