        ...
        <div className="flex flex-col gap-[45px]">
          ...
          <div className="transition-all flex max-lg:grid max-lg:grid-cols-1 gap-[20px]">
            ...
            <div
              ...
              style={{
                ['--solution_1' as any]: solutions[0].url
              }}
            >
              <div className="flex flex-col items-start gap-[12px] p-[24px]">
                ...
                <p className="text-[max(20px,_min(calc(100vw_*_(24_/_1440)),_24px))] text-white font-medium leading-[112%] -tracking-[.24px]">{solutions[0].title}</p>
              </div>
              <div className="flex flex-col items-start gap-[20px] bg-black group-[.is-not-active]/solution1:bg-[#19191B] p-[24px] group-[.is-active]/solution1:bg-[url('/image/solution-goverment.png')] max-lg:!bg-none bg-contain bg-right bg-no-repeat">
                <p className="text-[max(14px,_min(calc(100vw_*_(16_/_1440)),_16px))] text-white opacity-75 leading-[132%] -tracking-[.16px] max-w-md">{solutions[0].description}</p>
            ...
            <div ref={slide2Ref} className={cn("group/solution2 transition-all ease-[cubic-bezier(0.47,1.07,0.37,1.03)] duration-500 max-lg:w-full rounded-[12px] bg-[#365EFF] h-[475px] flex flex-col justify-between overflow-hidden", {
              ...
              <div className="flex flex-col items-start gap-[12px] p-[24px]">
                ...
                <p className="text-[max(20px,_min(calc(100vw_*_(24_/_1440)),_24px))] text-white font-medium leading-[112%] -tracking-[.24px]">{solutions[1].title}</p>
              </div>
              <div className="flex flex-col items-start gap-[20px] bg-[#365EFF] group-[.is-not-active]/solution2:bg-[#365EFF] p-[24px] group-[.is-active]/solution2:bg-[url('/image/solution-goverment.png')] max-lg:!bg-none bg-contain bg-right bg-no-repeat">
                <p className="text-[max(14px,_min(calc(100vw_*_(16_/_1440)),_16px))] text-white opacity-75 leading-[132%] -tracking-[.16px] max-w-md">{solutions[1].description}</p>
                <a href="#" className="block text-[14px] font-medium leading-[132%] -tracking-[.14px] p-[10px_16px] rounded-full bg-[#BEBEBE40] text-white hover:bg-white hover:text-[#19191B]" style={{
                  border: "1px solid rgba(207, 207, 207, 0.25)",
                  backdropFilter: "blur(2px)"
                }}>Get in touch</a>
