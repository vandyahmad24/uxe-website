      ...
      <div className="max-w-[1440px] mx-auto p-[max(48px,_min(calc(100vw_*_(80_/_1440)),_80px))_max(20px,_min(calc(100vw_*_(190_/_1440)),_190px))_48px_max(20px,_min(calc(100vw_*_(190_/_1440)),_190px))] max-xl:px-[max(20px,_min(calc(100vw_*_(70_/_1440)),_70px))] overflow-hidden">
        <div className="flex flex-col gap-[48px]">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-[32px] text-[#19191B] font-medium leading-[112%] -tracking-[.64px] mt-[10px] max-w-xl">Discover Innovation in <br /> Smart Security Products</h2>
          </div>
          <div className="grid grid-cols-3 gap-[20px] max-xl:grid-cols-2 max-md:grid-cols-1">
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="flex flex-col gap-[8px]">
                <h3 className="text-[20px] text-[#19191B] font-medium leading-[132%] -tracking-[.2px]">Thermal Camera</h3>
                <p className="text-[14px] text-[#19191B] opacity-60 leading-[132%] -tracking-[.14px]">The Elara FC-Series O</p>
              </div>
            </div>
            <div className="flex flex-col gap-[20px]">
              <div className="relative w-full pt-[112%] rounded-[12px] bg-[#F2F2F2]">
              ...
              <div className="flex flex-col gap-[8px]">
                <h3 className="text-[20px] text-[#19191B] font-medium leading-[132%] -tracking-[.2px]">Augment Reality</h3>
                <p className="text-[14px] text-[#19191B] opacity-60 leading-[132%] -tracking-[.14px]">The Elara FC-Series O</p>
              </div>
            </div>
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="flex flex-col gap-[8px]">
                <h3 className="text-[20px] text-[#19191B] font-medium leading-[132%] -tracking-[.2px]">Video Guard</h3>
                <p className="text-[14px] text-[#19191B] opacity-60 leading-[132%] -tracking-[.14px]">The Elara FC-Series O</p>
              </div>
            </div>
          </div>
          <div className="flex justify-center">
            <a href="#" className="text-[16px] text-white font-medium leading-[132%] -tracking-[.16px] p-[10px_16px] rounded-full bg-[#19191B]" style={{
