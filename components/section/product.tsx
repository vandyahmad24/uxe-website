            ...
            {products.map((item, index) => (
              <div key={index} className="flex flex-col gap-[20px]">
                ...
                <div className="flex flex-col gap-[8px]">
                  ...
                  <p className="text-[max(14px,_min(calc(100vw_*_(16_/_1440)),_16px))] text-[#19191B] opacity-60 leading-[132%] -tracking-[.14px]" dangerouslySetInnerHTML={{ __html: item.node.excerpt}}></p>
                </div>
              </div>
            ))}
          </div>
